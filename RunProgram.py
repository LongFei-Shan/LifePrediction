...
if __name__ == "__main__":
    ...
    # 读取特征索引
    featureIndex = pd.read_csv("./Data/FeatureData/featureIndex.csv", sep=",", encoding="utf-8").values.ravel()
    ...
    allLabel = pd.read_csv(f"./Data/FeatureData/label-{dirNames[0]}.csv", sep=",", encoding="utf-8").values[1:, :]
    for dirName in dirNames[1:]:
        ...
        templabel = pd.read_csv(f"./Data/FeatureData/label-{dirName}.csv", sep=",", encoding="utf-8").values[1:, :]
        tempfeature = tempfeature[:, featureIndex]
